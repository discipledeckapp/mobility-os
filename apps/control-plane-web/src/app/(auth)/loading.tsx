export default function ControlPlaneAuthLoading() {
  return (
    <div className="flex min-h-screen">
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between bg-[linear-gradient(150deg,#020617_0%,#0f172a_38%,#1d4ed8_100%)] px-12 py-10">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-[10px] bg-white/15" />
          <div className="space-y-2">
            <div className="h-4 w-20 rounded-full bg-white/20" />
            <div className="h-2.5 w-24 rounded-full bg-blue-200/20" />
          </div>
        </div>
        ...
        <div className="h-3 w-32 rounded-full bg-blue-100/15" />
      </div>
