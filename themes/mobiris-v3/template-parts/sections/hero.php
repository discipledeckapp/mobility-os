...
<section class="hero" aria-labelledby="hero-headline">
        ...
        <div class="hero__content">
            ...
            <?php if ( $label ) : ?>
                <div class="hero__label">
                    <span class="pill pill--brand"><?php echo esc_html( $label ); ?></span>
                </div>
            <?php endif; ?>

            <h1 id="hero-headline" class="heading heading--hero hero__headline">
            ...
            <div class="hero__ctas">
                <a href="<?php echo esc_url( $cta1_url ); ?>" class="btn btn--primary btn--full">
                ...
                >
                    <svg class="btn__wa-icon" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
    ...
    <div class="container hero__dashboard-wrap">
        <div class="hero__browser" role="img" aria-label="<?php esc_attr_e( 'Mobiris dashboard preview', 'mobiris-v3' ); ?>">
            <!-- Browser chrome -->
            ...
            <div class="hero__dashboard" aria-hidden="true">
                <div class="hero__stats-grid">
                    <?php
                    $stats = [
                        [ __( 'Active Drivers', 'mobiris-v3' ),     '48' ],
                        [ __( "Today's Remittance", 'mobiris-v3' ), '₦384,000' ],
                        [ __( 'Vehicles Assigned', 'mobiris-v3' ),  '43' ],
                        [ __( 'Overdue Payments', 'mobiris-v3' ),   '5' ],
                    ];
                    foreach ( $stats as $stat ) : ?>
                        <div class="hero__stat-card">
                            <p class="hero__stat-label"><?php echo esc_html( $stat[0] ); ?></p>
                            <p class="hero__stat-value"><?php echo esc_html( $stat[1] ); ?></p>
                        </div>
                    <?php endforeach; ?>
                </div>
                <div class="hero__table">
                    <div class="hero__table-header">
                        <span class="hero__table-title"><?php esc_html_e( 'Recent activity', 'mobiris-v3' ); ?></span>
                        <div class="hero__table-action"></div>
                    </div>
                    <?php
                    $rows = [
                        [ 'C', 'Chukwuemeka O.', '₦8,000', 'paid',    __( 'Paid',    'mobiris-v3' ) ],
                        [ 'A', 'Adebayo M.',      '₦8,000', 'pending', __( 'Pending', 'mobiris-v3' ) ],
                        [ 'I', 'Ifeanyi N.',      '₦8,000', 'paid',    __( 'Paid',    'mobiris-v3' ) ],
                    ];
                    foreach ( $rows as $row ) : ?>
                        <div class="hero__table-row">
                            <div class="hero__row-left">
                                <div class="hero__avatar"><?php echo esc_html( $row[0] ); ?></div>
                                <p class="hero__row-name"><?php echo esc_html( $row[1] ); ?></p>
                            </div>
                            <div class="hero__row-right">
                                <span class="hero__row-amount"><?php echo esc_html( $row[2] ); ?></span>
                                <span class="badge badge--<?php echo esc_attr( $row[3] ); ?>"><?php echo esc_html( $row[4] ); ?></span>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
