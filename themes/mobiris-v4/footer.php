        ...
        <div class="footer__grid">
            ...
            <div class="footer__brand">
                ...
                <div class="footer__app-badges">
                    ...
                    <?php if ( $ios && $ios !== '#' ) : ?>
                        <a href="<?php echo esc_url( $ios ); ?>" class="footer__badge" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e( 'Download on App Store', 'mobiris-v4' ); ?>">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
                            <?php esc_html_e( 'App Store', 'mobiris-v4' ); ?>
                        </a>
                    <?php endif; ?>
                    <?php if ( $and && $and !== '#' ) : ?>
                        <a href="<?php echo esc_url( $and ); ?>" class="footer__badge" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e( 'Get it on Google Play', 'mobiris-v4' ); ?>">
                            ...
                            <?php esc_html_e( 'Google Play', 'mobiris-v4' ); ?>
                        </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="footer__col">
                <p class="footer__col-heading"><?php esc_html_e( 'Product', 'mobiris-v4' ); ?></p>
                <ul>
                    <li><a href="<?php echo esc_url( $app_url ); ?>"><?php esc_html_e( 'Sign in', 'mobiris-v4' ); ?></a></li>
                    <li><a href="#how-it-works"><?php esc_html_e( 'How it works', 'mobiris-v4' ); ?></a></li>
                    <li><a href="#use-cases"><?php esc_html_e( "Who it's for", 'mobiris-v4' ); ?></a></li>
                    <li><a href="<?php echo esc_url( get_theme_mod( 'mobiris_app_ios_url', '#' ) ); ?>"><?php esc_html_e( 'iOS App', 'mobiris-v4' ); ?></a></li>
                    <li><a href="<?php echo esc_url( get_theme_mod( 'mobiris_app_android_url', '#' ) ); ?>"><?php esc_html_e( 'Android App', 'mobiris-v4' ); ?></a></li>
                </ul>
            </div>

            <!-- Resources links -->
            <div class="footer__col">
                <p class="footer__col-heading"><?php esc_html_e( 'Resources', 'mobiris-v4' ); ?></p>
                <ul>
                    <li><a href="<?php echo esc_url( home_url( '/tutorials' ) ); ?>"><?php esc_html_e( 'Tutorials', 'mobiris-v4' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/blog' ) ); ?>"><?php esc_html_e( 'Blog', 'mobiris-v4' ); ?></a></li>
                </ul>
            </div>

            <!-- Contact info -->
            <div class="footer__col">
                <p class="footer__col-heading"><?php esc_html_e( 'Contact', 'mobiris-v4' ); ?></p>
