...
<header class="nav" role="banner">
    <div class="container nav__inner">
        ...
        <nav class="nav__links" aria-label="<?php esc_attr_e( 'Primary', 'mobiris-v4' ); ?>">
        ...
        <!-- Mobile hamburger -->
        <button class="nav__hamburger" aria-label="<?php esc_attr_e( 'Toggle menu', 'mobiris-v4' ); ?>" aria-expanded="false" aria-controls="mobile-menu">
