...
<main id="main" class="tutorials-archive" role="main">
    <div class="page-hero">
        <div class="container--narrow">
            <p class="text-label page-hero__label"><?php esc_html_e( 'Tutorials', 'mobiris-v5' ); ?></p>
    ...
    <div class="container tutorials-archive__content">
        <?php if ( ! empty( $tut_cats ) && ! is_wp_error( $tut_cats ) ) : ?>
            <div class="tutorials-filter" role="tablist" aria-label="<?php esc_attr_e( 'Filter tutorials', 'mobiris-v5' ); ?>">
