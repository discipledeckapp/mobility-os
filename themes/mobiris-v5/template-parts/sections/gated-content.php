            ...
            <div class="gated__form-wrap">
                <div class="gated__form-card">
                    <form class="gated__form" data-resource="<?php echo esc_attr( $resource_id ); ?>" novalidate>
                        <label class="gated__form-label" for="gated-email"><?php esc_html_e( 'Your email address', 'mobiris-v5' ); ?></label>
                        <input
                            type="email"
                            id="gated-email"
                            name="email"
                    ...
                    <div class="gated__success" hidden>
                        ...
                        <h3 class="gated__success-title"><?php esc_html_e( "You're in!", 'mobiris-v5' ); ?></h3>
                        <p class="gated__success-msg"><?php esc_html_e( 'Your download is ready below.', 'mobiris-v5' ); ?></p>
                        <a href="#" class="btn btn--primary gated__download-btn" style="display:none;" download>
                            ...
                            <?php esc_html_e( 'Download the Guide', 'mobiris-v5' ); ?>
                        </a>
                    </div>
                </div>
            </div>
